...
class DeepFashionNet(nn.Module):
    def __init__(self):
        ...
        self.mp2 = nn.MaxPool2d(kernel_size=2, stride=2)  # 10*10

        self.conv5 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, padding=1, stride=1)  # 10*10
        self.relu5 = nn.ReLU()
        self.bn5 = nn.BatchNorm2d(256)  # 10*10
        nn.init.xavier_uniform_(self.conv5.weight)

        self.conv6 = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3)  # 8*8
        self.relu6 = nn.ReLU()
        self.bn6 = nn.BatchNorm2d(256)
        nn.init.xavier_uniform_(self.conv6.weight)
        self.mp3 = nn.MaxPool2d(kernel_size=2, stride=2)  # 4*4
